...
def draw(polygons, title, ax=None):
...
def main():
  ...
  fig1, ax1 = plt.subplots(3, 1, figsize=(12, 14))
  ...
  draw(ribbons, 'Параллельные ленты', ax2[0, 0])
  ...
  draw(cross, 'Пересекающиеся ленты', ax2[0, 1])
  ...
  draw(sym, 'Симметричные треугольники', ax2[1, 0])
